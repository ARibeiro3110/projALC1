...
This git repository belongs to group 20 and is intended for project1 of alc24.
...
The result of the project evaluation using this set of holdout tests will be available in the [README](https://gitlab.rnl.tecnico.ulisboa.pt/alc24/feedback/project1/20/-/tree/master/README.md) of the feedback repository after each code submission.
